...
•If we don’t write any constructor, compiler will provide a default
constructor.
...
•I am not writing it in every lecture because I have to focus on
actual topic.
Why copy constructor should take
reference?
...
*Can we read values inside the constructor
using cin?
...
Trees etc.
• if member of a class is a pointer 'p' and it is pointing to array or
object in heap.
• if object A is having its member 'p' pointing on an array or object
in heap and you are making a copy of A as B then 'p' of B will also
point on same array or object of A.
• to have separate copy of B another array or object should be
created and make 'p' point on it.
